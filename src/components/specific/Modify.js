...
function Modify() {
  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      try {
        const response = await axios.get('https://3.36.27.202:4040/api/v1/mypage/userinfo', {
          headers: {
  ...
  const handlePasswordCheck = async () => {
    const token = localStorage.getItem('token');
    try {
      const response = await axios.post('https://3.36.27.202:4040/api/v1/mypage/checkpassword', {
  ...
  const handleNickCheck = async () => {
    ...
    try {
      const response = await axios.post('https://3.36.27.202:4040/api/v1/auth/check-nickname', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.patch('https://3.36.27.202:4040/api/v1/mypage/modify', {
